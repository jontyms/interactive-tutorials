...
Unlike languages like C and C++, we can use **else** for loops. When the loop condition "for" or "while" fails then code in the "else" part is executed. If a **break** statement is executed inside the for loop then the "else" part is skipped.
